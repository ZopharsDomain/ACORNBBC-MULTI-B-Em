...
void dumpuservia()
{
        printf("T1 = %04X %04X T2 = %04X %04X\n",(unsigned int)uservia.t1c,(unsigned int)uservia.t1l,(unsigned int)uservia.t2c,(unsigned int)uservia.t2l);
        printf("%02X %02X  %02X %02X\n",(unsigned int)uservia.ifr,(unsigned int)uservia.ier,(unsigned int)uservia.pcr,(unsigned int)uservia.acr);
}
